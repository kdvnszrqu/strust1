...
var offmapcfg = {
  ...
  'tiles_dir'   : './images/tiles',       //普通瓦片图的地址，为空默认在 offlineemap/tiles/ 目录
  'tiles_hybrid': './images/tiles_hybrid',       //卫星瓦片图的地址，为空默认在 offlinemap/tiles_hybrid/ 目录
  'tiles_self'  : './images/tiles__self'        //自定义图层的地址，为空默认在 offlineemap/tiles_self/ 目录
};
